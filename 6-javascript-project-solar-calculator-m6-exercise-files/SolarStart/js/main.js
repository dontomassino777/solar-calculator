...
function addMonths(elem) {
    ...
    dailyUseKw = Math.round(annualUseKw/365);
    return dailyUseKw;
}
...
function calculateSolar() {
    ...
    let feedback = "";
    feedback += `<p>Based on your avg. daily use of ${dailyUseKw} kWh, you'll need to purchase ${panelsNeeded} ${panelName} solar panels to offset 100% of your electricity bill.</p>`;
    feedback += "<h2>Additional Details</h2>";
    feedback += `<p>Your avg. daily electricity consumption: ${dailyUseKw} Kwh per day.</p>`;
